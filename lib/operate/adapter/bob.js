...
class Bob extends Adapter {
   ...
   * @return {Promise}
   */
  static async fetchTx(txid, opts = {}) {
    ...
    const headers = { key: opts.apiKey || "_" }; // Bob expects a key, although it is unused at the moment
   ...
   * @return {Promise}
   */
  static async fetchTxBy(query, opts = {}) {
    ...
    const headers = { key: opts.apiKey || "_" };
